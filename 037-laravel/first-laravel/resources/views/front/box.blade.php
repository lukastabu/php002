    ...
    <div>
        <form class="" action="{{ route('front-index') }}" method="GET">
            ...
            <select name="sort">
                ...
                <option value="height-asc" @if ($sort == 'height-asc') selected @endif>Height min-max</option>
                <option value="height-desc" @if ($sort == 'height-desc') selected @endif>Height max-min</option>
            </select>
